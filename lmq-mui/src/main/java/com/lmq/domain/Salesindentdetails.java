...
public class Salesindentdetails {
    private Integer id;

    private Integer salesindentid;
    ...
    public Integer getSalesindentid() {
        return salesindentid;
    }

    public void setSalesindentid(Integer salesindentid) {
        this.salesindentid = salesindentid;
    }
